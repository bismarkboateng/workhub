...
const blog = (props) => {
  return (
    ...
    <section className='w-[90%] md:w-[95%] 2xl:w-[64%] mx-auto'>
      ...
      <div className='grid grid-cols-2 gap-y-2 md:gap-y-0 md:grid-cols-4 
        gap-x-4 mt-8 md:w-[80%] mx-auto'>
        <Button
        ...
        <button className="bg-transparent text-lg text-blue-950 border border-[#53587a] cursor-pointer py-2 px-4 rounded">Workplace</button>
        <button className="bg-transparent text-lg text-blue-950 border border-[#53587a] cursor-pointer py-2 px-4 rounded">Technology</button>
        <button className="bg-transparent text-lg text-blue-950 border border-[#53587a] cursor-pointer py-2 px-4 rounded">Wellness</button>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-x-16" >
        <div className=''>
          <BlogPost
              image={Cat}
      ...
      <section className="flex mt-10 justify-center" data-aos="zoom-in" data-aos-offset="200" data-aos-duration="1000">
